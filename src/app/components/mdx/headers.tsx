...
export function H1(props: HeadersProps) {
  ...
  return (
    <div className="flex flex-col justify-center items-center"><h1 id={idText} className="font-black text-3xl my-2 text-center">{props?.children}</h1><hr className="my-2 rounded-full w-[99%] bg-neutral-950/15 dark:bg-neutral-50/15"/></div>
  )
}
